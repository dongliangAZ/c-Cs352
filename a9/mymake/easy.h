...
int isword(char *aword){
 ...
 void adjlist_add_vertex (char *data) {
     ...
     new_vnode->val = strdup(data);new_vnode->v=0;
 ...
 void adjlist_free () {
     ...
     while (vnode) { 
        ...
        vnode2=vnode->next_vnode;free(vnode->val); 
