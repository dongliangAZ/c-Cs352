...
touch -t 160501011050.01 _testTarg4
touch -t 160501011014.01 _testDep5
touch -t 160501011045.01 _testDep4
touch -t 160501011009.01 _testDep2
touch -t 160501011036.01 _testDep3
touch -t 160501011003.01 _testDep1
#rm -f _testTarg1
#rm -f _testTarg2
#rm -f _testTarg3
rm -f _testTarg4
...
ulimit -t 10
valgrind $vgopts -q ./mymake ${BASEDIR}/mfile15 _testTarg1 >${outfile} 2>${errfile}
exitstatus=$?
